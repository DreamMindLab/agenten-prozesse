...
4. Lies alle Dateien in `marke/` (Zielgruppe, Angebot, Tonalität, Design, Beispiele, Regeln) und [grundlagen/qualitaet-und-lernen.md](grundlagen/qualitaet-und-lernen.md).
