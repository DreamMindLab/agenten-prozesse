...
**Nachtrag (nach Jans Freigabe):** Baustein 8 „Formattest und Durchhalten“ eingebaut (Hauptplattform, eine Schublade, 3–4 Formate × ca. 10 Videos in 30 Tagen über Trial Reels oder anonymen Test-Account, Gewinner nach Baustein 5, nicht Talking Head mit Text-im-Bild mischen, Gewinner als Serie, 6–12 Monate ein Format, erst Reels dann Stories, Profil zweitrangig). Verweise aus Positionierung (Abschnitt „Die ersten 30 Tage“ im Dokument), Video-Marketing v3 (Schritt 5) und Contentplan.

**Folge #119** (Jan: älter; bei Widerspruch gelten #136/#140). Jan hat keine Rohfassung geschickt, sondern eine KI-Zusammenfassung, „ergänzt mit 2026 Carousel & Caption Best-Practice“. Übernommen nur, was erkennbar von Torben stammt: Trial Reels als Testweg, Gewinner als Serie, eine Schublade mit Caption-Stichwörtern, Stories erst nach stabilem Reel-Rhythmus, Loop statt Pflicht-CTA (Reel Schritt 7 und Quality Check), Bild-Hook und kein vorausgesetzter Fachbegriff (Reel Schritt 6), Freunde-Kommentare herausrechnen, „kein Shadowban, schwache Werte“, 70–80 % Wiedergabe für fünfstellige Reichweite (aus #140).
**Widersprüche, neuere Folgen gewinnen:** Wiedergabe ≥ 75/85/95 % (#119) → 60–70 %; ca. 45 Reels im Testmonat → 3–4 Formate × ca. 10; Hook 2–2,5 s → 3 s; „der erste Rollout entscheidet“ → frühestens nach 7 Tagen auswerten.
**Verworfen aus der Zusammenfassung:** PASTOR-Caption, 150–200 Wörter, Karussell-Wortlimits, „Fragezeichen auf Slide 1 performt messbar schlechter“, CTA-Listen, 85 %/50 % Nutzungszahlen, „Instagram lukrativer als TikTok“ (ohne Quelle bzw. nicht von Torben; Karussell-Aufbau im Repo ist belegt und deckt sich weitgehend).
